 ...
 * 向左滑动action
 */
public class RightSwipeAction implements Action {

    private final Pointer pointer;

    private final ActionType type = ActionType.RIGHT_SWIPE;
    private int order;
    ...
    public RightSwipeAction(Pointer pointer) {
    ...
    @Override
    public void execute() {
        GestureSimulator.instance().swipeRight(pointer, duration);
    }
